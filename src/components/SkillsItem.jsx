...
const SkillsItem = ({category, description, skills, video}) => {
  return (
    <div className='text-pretty w-full h-full relative flex flex-col not-dark:border not-dark:border-gray-300 rounded-2xl dark:bg-[#1b1b1b] max-w-xl group transition-all duration-100'>
        ...
        <h2 className='text-[40px] max-md:text-2xl font-poppins font-bold self-center p-2 max-md:max-w-[90%] text-center mb-2 transition-all duration-300'>{category}</h2>
