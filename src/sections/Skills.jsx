...
const Skills = () => {
  return (
    <section
      name="Skills"
      className="flex max-xl:flex-col justify-center xl:justify-between px-16 pt-6 gap-8"
    >
      <div className="flex flex-col justify-center items-center pointer-events-none max-xl:mx-auto xl:[writing-mode:vertical-rl] xl:rotate-180 max-xl:mb-8 z-10">
