...
const Skills = () => {
  return (
    <section name="Skills" className='flex md:mb-20 mb-10 max-xl:flex-col justify-center xl:justify-between px-[10%] pt-6'>
        <div className="flex flex-col justify-center items-center xl:flex-1/5 pointer-events-none max-xl:mx-auto xl:[writing-mode:vertical-rl] xl:rotate-180 mt-10 max-xl:mb-8 z-10">
          ...
          <p className="xl:text-[110px] text-7xl max-md:text-5xl tracking-tight font-bold text-center font-poppins">Expertise</p>
        </div>
