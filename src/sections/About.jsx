...
const About = () => {
  return (
    <section name="About" className="flex mt-8 items-center">
      ...
      <div className="relative flex w-full h-[70dvh] max-md:h-[60dvh] border-4 rounded-2xl p-4">
        <div className="flex px-10 z-1 h-full justify-center max-lg:items-end max-lg:px-4 items-center relative">
          ...
          />
          <div className="relative flex flex-1 flex-col max-md:max-h-[60%] backdrop-blur-xs rounded-2xl border-2 border-primary-dark text-primary-dark dark:text-primary-light dark:max-md:text-primary-dark dark:max-md:backdrop-brightness-75 px-6 py-3 justify-center text-pretty max-md:text-sm max-lg:mb-4">
