      ...
      <div className="relative flex w-full h-[70dvh] border-4 rounded-2xl p-4">
        <div className="flex lg:px-10 z-1 h-full justify-center max-lg:items-end items-center relative">
          ...
          <img
            ...
            alt="myself-about"
            className="flex-1 md:h-full object-contain max-lg:absolute max-md:bottom-0"
          />
          <div className="relative flex flex-1 flex-col max-lg:justify-stretch max-md:h-[50%] backdrop-blur-xs rounded-2xl border-2 border-primary-dark text-primary-dark dark:text-primary-light dark:max-md:text-primary-dark dark:max-md:backdrop-brightness-75 max-lg:rounded-b-xl max-lg:rounded-none max-lg:border-0 px-6 py-3 justify-center text-pretty max-md:text-sm">
